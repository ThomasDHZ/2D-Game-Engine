...
public enum VkAccessFlags
{
    ...
    VK_ACCESS_VERTEX_SHADER_READ_BIT = 0x00000008,
    VK_ACCESS_FRAGMENT_SHADER_READ_BIT = 0x00000010,
    VK_ACCESS_COMPUTE_SHADER_READ_BIT = 0x00000020,
    VK_ACCESS_TRANSFER_READ_BIT = 0x00000040,
    VK_ACCESS_TRANSFER_WRITE_BIT = 0x00000080,
    VK_ACCESS_COLOR_ATTACHMENT_READ_BIT = 0x00000100,
    VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT = 0x00000200,
    VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT = 0x00000400,
    VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT = 0x00000800,
    VK_ACCESS_HOST_READ_BIT = 0x00001000,
    VK_ACCESS_HOST_WRITE_BIT = 0x00002000,
    VK_ACCESS_MEMORY_READ_BIT = 0x00004000,
    VK_ACCESS_MEMORY_WRITE_BIT = 0x00008000,
...
public enum VkShaderStageFlags
{
    ...
    VK_SHADER_STAGE_COMPUTE_BIT = 0x00000004,
...
public enum VkQueryType
{
    ...
    VK_QUERY_TYPE_PIPELINE_STATISTIC = 1,
...
// VkQueryPipelineStatisticFlags Enum
[Flags]
public enum VkQueryPipelineStatisticFlags
{
    ...
    VK_QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS = 0x00000020,
    VK_QUERY_PIPELINE_STATISTIC_COMPUTE_SHADER_INVOCATIONS = 0x00000040,
    VK_QUERY_PIPELINE_STATISTIC_MAX_ENUM = 0x7FFFFFFF
}

// VkPipelineCreateFlags Enum
[Flags]
...
// VkShaderModuleCreateFlags Enum
[Flags]
...
// VkCommandPoolCreateFlags Enum
[Flags]
public enum VkCommandPoolCreateFlags
{
    VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT = 0x00000001,
    VK_COMMAND_POOL_CREATE_PROTECTED_BIT = 0x00000002,
    VK_COMMAND_POOL_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF
}

// VkExternalMemoryHandleTypeFlags Enum
[Flags]
public enum VkExternalMemoryHandleTypeFlags
{
    ...
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_IMAGE_BIT = 0x00000008,
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT = 0x00000010,
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_ACCELERATION_STRUCTURE_BIT_KHR = 0x00000020,
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_MAX_ENUM = 0x7FFFFFFF
}

// VkExternalMemoryFeatureFlags Enum
[Flags]
public enum VkExternalMemoryFeatureFlags
{
    ...
    VK_EXTERNAL_MEMORY_FEATURE_MAX_ENUM = 0x7FFFFFFF
}

// VkFormatFeatureFlags Enum
[Flags]
public enum VkFormatFeatureFlags
{
    ...
    VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT = 0x00000020,
    VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT = 0x00000040,
    VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT = 0x00000080,
    VK_FORMAT_FEATURE_TRANSFER_SRC_BIT = 0x00000100,
    VK_FORMAT_FEATURE_TRANSFER_DST_BIT = 0x00000200,
    VK_FORMAT_FEATURE_MIDPOINT_COLOR_TRANSFER_BIT = 0x00000400,
    VK_FORMAT_FEATURE_SAMPLE_RESOLVE_BIT = 0x00000800,
    VK_FORMAT_FEATURE_BLEND_SRC_BIT = 0x00001000,
    VK_FORMAT_FEATURE_BLEND_DST_BIT = 0x00002000,
...
[Flags]
public enum VkDebugUtilsMessageSeverityFlagBitsEXT : ulong
{
...
[Flags]
public enum VkDebugUtilsMessageTypeFlagsEXT : ulong
{
    VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT = 0x00000001,                 // 1
    VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT = 0x00000002,              // 2
    VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT = 0x00000004,             // 4
    VK_DEBUG_UTILS_MESSAGE_TYPE_DEVICE_ADDRESS_BINDING_BIT_EXT = 0x00000008,  // 8
    VK_DEBUG_UTILS_MESSAGE_TYPE_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF           // Max enum value
}
